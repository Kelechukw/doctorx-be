...
var userContoller = function userContoller(userUseCase) {
  return {
    createUser: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                userData = req.body;
                _context.next = 4;
                return userUseCase.createUser(userData);

              case 4:
                user = _context.sent;
                return _context.abrupt("return", _response["default"].success(res, user, 201));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                data = req.body;
                _context2.next = 4;
                return userUseCase.loginUser(data);
